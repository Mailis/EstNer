...
<html lang="en">
	...
	<div class="nav">
	    ...
	    <div class="item_horizontal_min_error">
		<legend>authentication errors:</legend>
                <?php $dirname = $upperFolder.'auth_errors/'; ?>
		<a class="cap" href = "<?= $dirname; ?>">authentication errors folder</a>
		    <br />
		    <?php echoErrors($dirname) ?>
	        <hr><hr>
	    </div>
	    ...
	    <div class="item_horizontal_min_error">
		<legend>connection errors:</legend>
                <?php $dirname = $upperFolder.'connection_errors/'; ?>
		<a class="cap" href = "<?= $dirname; ?>">connection errors folder</a>
		    <br />
		    <?php echoErrors($dirname) ?>
	        <hr><hr>
	    </div>
