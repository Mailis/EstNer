...
def getEntities(url, text, ontologyData, orgWords=['kogu', 'selts', 'ansambel', 'keskus', 'as', 'klubi', 'asutus', 'keskus', 'fond', 'cup'], locWords=['vabarii', 'maakond']):
    ntwl = list()
    try:
                ...
                if label == "PER":
                    ...
                    if(freqLemma != ""):
                        ...
                        try:
                            ...
                            comm.printException(comm.pathToSaveParsingErrors, "getEntities.py-def_getEntities_gname-fname")
                            pass
                        ...
                        if ((ontologyData.sharedList_per)._callmethod('__len__') > comm.chunksize):
                            try:
                                ...
                                perManager = initRdf.PeopleManager(ontologyData)
                    ...
                    if ((ontologyData.sharedList_org)._callmethod('__len__') > comm.chunksize):
                        try:
                            ...
                            #jf.close() 
                            orgManager = initRdf.OrganizationManager(ontologyData)
